...
# Switch definitions (end of extended GPIO for B+ boards)
# Tuner rotary encoder
# MENU_SWITCH = 21
# LEFT_SWITCH = 16
# RIGHT_SWITCH = 13
...
class MyDaemon(Daemon):
	...
	def run(self):
		...
		lcd.line2("IP " + ipaddr)
		time.sleep(6)
		log.message("Starting MPD/MOPIDY", log.INFO)
		lcd.line2("Starting MPD/MOPIDY")
		radio.start()
		log.message("MPD/MOPIDY started", log.INFO)

		log.message("so far so good", log.INFO)
